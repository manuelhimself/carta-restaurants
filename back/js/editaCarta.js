$(document).ready(function () {
    ...
    function getCarta(id) {
        ...
        xhttp.open("GET", "https://admin.restaurat.me/api/controller/carta/readByIdCarta.php?idCarta=" + id, false);
        xhttp.send();
    }
    ...
    function getCartes() {
        ...
        xhttp.open("GET", "https://admin.restaurat.me/api/controller/carta/readByIdEstabliment.php?idEstabliment=" + idEstabliment, false);
        xhttp.send();
    }
    ...
    function getSeccions(idC) {
        ...
        xhttp.open("GET", "https://admin.restaurat.me/api/controller/seccio/readByIdCarta.php?idCarta=" + idC, false);
        xhttp.send();
    }
    ...
    function eliminarSeccio(idSeccio, idCarta) {
        ...
        xhttp.open("GET", "https://admin.restaurat.me/api/controller/seccio/delete1.php?idSeccio=" + idSeccio, false);
        xhttp.send();
    }
    ...
    function eliminarCarta(idCarta) {
        ...
        xhttp.open("GET", "https://admin.restaurat.me/api/controller/carta/delete1.php?idCarta=" + idCarta, false);
        xhttp.send();
    }
    ...
    function actualitzarNomSeccio(idSeccio, nomSeccio) {
        ...
        xhttp.open("GET", api + "https://admin.restaurat.me/api/controller/seccio/update.php?idSeccio=" + idSeccio + "&nomSeccio=" + nomSeccio, true);
        xhttp.send();
    }
    ...
    function actualitzarNomCarta(idCarta, nomCarta) {
        ...
        xhttp.open("GET", "https://admin.restaurat.me/api/controller/carta/update.php?idCarta=" + idCarta + "&nomCarta=" + nomCarta, true);
        xhttp.send();
    }
    ...
    function afegirCarta(nomCarta) {
        ...
        xhttp.open("GET", "https://admin.restaurat.me/api/controller/carta/create.php?nomCarta=" + nomCarta + "&idEstabliment=" + idEstabliment, true);
        xhttp.send();
    }
    ...
    function afegirSeccio(nomSeccio, idCarta) {
        ...
        xhttp.open("GET", "https://admin.restaurat.me/api/controller/seccio/create.php?nomSeccio=" + nomSeccio + "&idCarta=" + idCarta, true);
        xhttp.send();
    }
    ...
    function activarCarta(idCarta) {
        ...
        xhttp.open("GET", "https://admin.restaurat.me/api/controller/carta/activate.php?idCarta=" + idCarta, true);
        xhttp.send();
    }
    ...
    function desactivarCarta(idCarta) {
        ...
        xhttp.open("GET", "https://admin.restaurat.me/api/controller/carta/desactivate.php?idCarta=" + idCarta, true);
        xhttp.send();
    }
