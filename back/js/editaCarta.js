$(document).ready(function () {
    ...
    function getCarta(id) {
        ...
        xhttp.open("GET", api + "controller/carta/readByIdCarta.php?idCarta=" + id, false);
        xhttp.send();
    }
    ...
    function getCartes() {
        ...
        xhttp.open("GET", api + "controller/carta/readByIdEstabliment.php?idEstabliment=" + idEstabliment, false);
        xhttp.send();
    }
    ...
    function getSeccions(idC) {
        ...
        xhttp.open("GET", api + "controller/seccio/readByIdCarta.php?idCarta=" + idC, false);
        xhttp.send();
    }
    ...
    function mostrarCartes() {
        ...
        for (var i = 0; i < cartes.length; i++) {
            ...
            var cardDIV = $("<div/>", { class: "card", id: "da" });
    ...
    function eliminarSeccio(idSeccio, idCarta) {
        ...
        xhttp.open("GET", api + "controller/seccio/delete1.php?idSeccio=" + idSeccio, false);
        xhttp.send();
    }
    ...
    function eliminarCarta(idCarta) {
        ...
        xhttp.open("GET", api + "controller/carta/delete1.php?idCarta=" + idCarta, false);
        xhttp.send();
    }
    ...
    function actualitzarNomSeccio(idSeccio, nomSeccio) {
        ...
        xhttp.open("GET", api + "controller/seccio/update.php?idSeccio=" + idSeccio + "&nomSeccio=" + nomSeccio, true);
        xhttp.send();
    }
    ...
    function actualitzarNomCarta(idCarta, nomCarta) {
        ...
        xhttp.open("GET", api + "controller/carta/update.php?idCarta=" + idCarta + "&nomCarta=" + nomCarta, true);
        xhttp.send();
    }
    ...
    function afegirCarta(nomCarta, idE) {
        ...
        xhttp.open("GET", api + "controller/carta/create.php?nomCarta=" + nomCarta + "&idEstabliment=" + idE, true);
        xhttp.send();
    }
    ...
    function afegirSeccio(nomSeccio, idCarta) {
        ...
        xhttp.open("GET", api + "controller/seccio/create.php?nomSeccio=" + nomSeccio + "&idCarta=" + idCarta, true);
        xhttp.send();
    }
    ...
    function activarCarta(idCarta) {
        ...
        xhttp.open("GET", api + "controller/carta/activate.php?idCarta=" + idCarta, true);
        xhttp.send();
    }
    ...
    function desactivarCarta(idCarta) {
        ...
        xhttp.open("GET", api + "controller/carta/desactivate.php?idCarta=" + idCarta, true);
        xhttp.send();
    }
