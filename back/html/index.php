                ...
                <div class="wrapper row">
                    ...
                    <div class="details col-md-6">
                        ...
                        <div class="action col-md-12">
                            <button class="float-right btn realBtn" data-toggle="modal" data-target="#modalEditaPerfil" type="button" id="edita-perfil" style="margin-right: 10px">Edita perfil</button>
                        </div>
                    </div>
                </div>
            </div>
