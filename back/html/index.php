...
<head>
    ...
    <link rel="icon" href="html/images/icon/icon.png">
    <script type="text/javascript" src="html/js/api.js"></script>
    <script type="text/javascript" src="html/js/editaPerfil.js"></script>
