$(document).ready(function () {
    ...
    function getAlergens() {
        ...
        xhttp.open("GET", "https://admin.restaurat.me/api/controller/alergen/read.php", false);
        xhttp.send();
    }
    ...
    function totsPlats(idS){
        ...
        xhttp.open("GET", "https://admin.restaurat.me/api/controller/plat/readByIdSeccio.php?idSeccio="+idS, false);
        xhttp.send();
    }
    ...
    function platsAlergen(idAlergen, idS){
        ...
        xhttp.open("GET", "https://admin.restaurat.me/api/controller/plat/readByIdAlergen.php?idAlergen="+idAlergen +"&idSeccio="+idS, false);
        xhttp.send();
    }
    ...
    function eliminarPlat(idPlat) {
        ...
        xhttp.open("GET", "https://admin.restaurat.me/api/controller/plat/delete.php?idPlat=" + idPlat, false);
        xhttp.send();
    }
    ...
    function modificarPlat(idPlat,nom,descripcio,preu) {
        ...
        xhttp.open("GET", "https://admin.restaurat.me/api/controller/plat/update.php?idPlat="+idPlat+"&nom="+nom+"&descripcio="+descripcio+"&preu="+preu, false);
        xhttp.send();
    }
    ...
    function getAlergensPlat(idPlat){
        ...
        xhttp.open("GET", "https://admin.restaurat.me/api/controller/plat/readByIdPlat.php?idPlat=" + idPlat, false);
        xhttp.send();
    }
    ...
    function eliminarAlergensPlat(idPlat){
        ...
        xhttp.open("GET", "https://admin.restaurat.me/api/controller/alergen/deleteAllAlergenByIdPlat.php?idPlat="+idPlat, false);
        xhttp.send();
    }
    ...
    function afegirPlat(nom,descripcio,preu,idS){
        ...
        xhttp.open("GET", "https://admin.restaurat.me/api/controller/plat/createPlat.php?nom="+nom+"&descripcio="+descripcio+"&preu="+preu+"&idSeccio="+idS, false);
        xhttp.send();
    }
    ...
    function afegirAlergenPlat(idAlergen, idPlat){
        ...
        xhttp.open("GET", "https://admin.restaurat.me/api/controller/plat/createAlergenPlat.php?idPlat="+idPlat+"&idAlergen="+idAlergen, false);
        xhttp.send();
    }
