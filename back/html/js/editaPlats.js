$(document).ready(function() {
    ...
    function mostraPlats() {
        ...
        for (var i = 0; i < plats.length; i++) {
            ...
            var cardImg = $("<img/>", { class: "img-fluid d-block mx-auto mb-3 imgRodona", onerror:"this.onerror=null", "this.src": "/images/plat/default.jpg", alt: "plat", src: "/images/plat/" + idPlat + ".jpg" });
